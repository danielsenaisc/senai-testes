var EditableTableManaged = function () {
    ...
    var handleTable = function (table_name, table_id) {
        ...
        var select_type_input = '<select class="form-control input-sm"><option>Facebook</option><option>SAC</option><option>Site</option></select>';

        var select_location_input = '<select class="form-control input-sm"><option>ALL</option><option>Brasil</option><option>EUA</option></select>';

        var text_input = '<input type="text" class="form-control input-medium" style="margin-left:40px;" placeholder="Novo canal...">';
        ...
        function saveRow(oTable, nRow) {
            ...
            oTable.fnUpdate('<a class="delete" href="">Excluir</a>', nRow, 4, false);
        ...
        table.on('click', '.delete', function (e) {
            ...
            alert("Removido! Obs.: Chamar algum script/ajax de backend para atualização do backend!");
        });
