...
public class PaisDAO extends AbstractDAO {
    ...
    private ArrayList<Pais> montarObjeto(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            BigDecimal codigoContinente = rs.getBigDecimal(Columns.continenteCodigo);
            ...
            Continente continente = continenteDao.selectById(codigoContinente);
    ...
    public void insert(Pais pais) {
            ...
            String sqlParam = String.format(sql, Tables.pais, Columns.nome, Columns.sigla, Columns.continenteCodigo, Columns.nacionalidade);
    ...
    public void update(Pais pais) {
            ...
            String sqlParam = String.format(sql, Tables.pais, Columns.nome, Columns.sigla, Columns.continenteCodigo, Columns.nacionalidade, Columns.id);
